...
var xin_table = $('#xin_table').dataTable({
	"bDestroy": true,
	"ajax": {
		//url : site_url+"timesheet/update_attendance_list/?employee_id="+$('#employee_id').val()+"&start_date="+$('#start_date').val()+"&end_date="+$("#end_date").val(),
...
$("#update_attendance_report").submit(function(e){
	...
	var xin_table2 = $('#xin_table').dataTable({
		"bDestroy": true,
		"ajax": {
			//url : site_url+"timesheet/update_attendance_list/?employee_id="+employee_id+"&start_date="+start_date+"&end_date="+end_date,
