...
class Languages extends MY_Controller
{
   ...
   /*Function to set JSON output*/
	...
	//	$directoryName = 'images';
		$new_dir 	= 'app/language/'.$this->input->post('language_code');
		$directoryName 	= $new_dir.'/hr_mii_lang.php';
		...
		$srcfile 	= 'app/language/english/hr_mii_lang.php';
		$srcfile2 	= 'app/language/english/index.html';
		// copy files
