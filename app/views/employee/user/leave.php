...
<div class="row">
  ...
  <?php
  $total=$this->Timesheet_model->sisacuti($type->leave_type_id,$session['user_id']);
    ...
    <div class="card mb-4">
      <div class="card-body">
        <div class="d-flex align-items-center">
          ...
          <div class="ml-3">
            <div class="text-muted small"> <?php echo $type->type_name;?> (<?php echo $terpakai;?>/<?php echo $type->days_per_year;?>)</div>
