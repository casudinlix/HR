                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_xin_status');?>" disabled>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea disabled class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_remarks');?>" name="remarks" id="remarks" cols="30" rows="5"><?php echo $remarks;?></textarea>
                      </div>
                    </div>
                  </div>
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="card-block card-dashboard">
                ...
                <?php
                $total=$this->Timesheet_model->sisacuti($type->leave_type_id,$employee_id);
        ...
        ?>
                <div id="leave-statistics">
                  <p><strong><?php echo $type->type_name;?> (<?php echo $terpakai;?>/<?php echo $type->days_per_year;?>)</strong></p>
