            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="<?php echo $this->lang->line('shift2');?>" name="shift2" type="text" value="<?php echo $shift2;?>">
                </div>
                <div class="form-group">
                  <label for="overtime_rate" class="control-label"><?php echo $this->lang->line('shift3');?></label>
                  <input class="form-control" placeholder="<?php echo $this->lang->line('shift3');?>" name="shift3" type="text" value="<?php echo $shift3;?>">
                </div>
              </div>
            </div>
          </div>
