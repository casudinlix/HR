                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_payroll_overtime_rate');?>" name="overtime_rate" value="0" type="number">
                    </div>
                    <div class="form-group">
                      <label for="overtime_rate" class="control-label"><?php echo $this->lang->line('shift2');?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('shift2');?>" name="shift2" value="0" type="number">
                    </div>
                    <div class="form-group">
                      <label for="overtime_rate" class="control-label"><?php echo $this->lang->line('shift3');?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('shift3');?>" name="shift3" value="0" type="number">
                    </div>
                  </div>
                </div>
              </div>
