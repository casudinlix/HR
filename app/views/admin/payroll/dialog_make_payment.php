   ...
   <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          <label for="payment_method">Work Day</label>
          <input type="" name="work_day" class="form-control" required="">
        </div>
        <div class="form-group">
          <label for="payment_method">Tunjangan Suka Duka</label>
          <input type="" name="suka_duka" class="form-control" required="">
        </div>
      </div>
