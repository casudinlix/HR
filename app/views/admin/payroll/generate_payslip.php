    ...
    <table class="datatables-demo table table-striped table-bordered" id="xin_table">
      <thead>
        <tr>
          ...
          <th>Shift Sore</th>
          <th>Shift Malam</th>
            <th><?php echo $this->lang->line('cuti'); ?></th>
              <th><?php echo $this->lang->line('sakit_ijin'); ?></th>
              <th><?php echo $this->lang->line('ijinkhusus'); ?></th>
                <th><?php echo $this->lang->line('alpa'); ?></th>
                  <th>Telat</th>
                  <th>Pulang Cepat</th>
                    <th><?php echo $this->lang->line('ot9'); ?></th>
                        <th><?php echo $this->lang->line('ot10'); ?></th>
                            <th><?php echo $this->lang->line('oth8'); ?></th>
                                <th><?php echo $this->lang->line('oth9'); ?></th>
                                    <th><?php echo $this->lang->line('oth10'); ?></th>
