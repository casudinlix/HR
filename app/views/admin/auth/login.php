...
<head>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="<?php echo tema()?>vendor/css/pages/authentication.css">

  <link rel="stylesheet" href="<?php echo tema();?>vendor/toastr/toastr.min.css">
  <link media="all" type="text/css" rel="stylesheet" href="<?php echo tema();?>css/hrsale/animate.css">
</head>
...
<body>
  ...
  <div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('<?php echo tema();?>img/bg/bg-3.jpg');">
        ...
        <div class="p-4 p-sm-5">
          ...
          <div class="d-flex justify-content-center align-items-center pb-2 mb-4">
              <div class="position-relative">
                <div class="p-1"><img src="<?php echo base_url();?>uploads/logo/signin/<?php echo $company[0]->sign_in_logo;?>" alt="hr_MII logo"></div>
            </div>
          </div>
          <!-- / Logo -->
          ...
          <?php $attributes = array('class' => 'form-horizontal form-simple', 'name' => 'hrm-form', 'id' => 'hrm-form', 'data-redirect' => 'dashboard', 'data-form-table' => 'login', 'data-is-redirect' => '1', 'autocomplete' => 'off');?>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="iusername" name="iusername" placeholder="NIP" autocomplete="off">
            </div>
            <div class="form-group">
  ...
  <script type="text/javascript" src="<?php echo tema();?>vendor/jquery/jquery-3.2.1.min.js"></script>
...
<script type="text/javascript" src="<?php echo tema();?>scripts/xin_login.js"></script>
<script type="text/javascript">
$(document).ready(function(){
