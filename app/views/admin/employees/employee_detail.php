  ...
  <div class="row no-gutters row-bordered row-border-light">
    <div class="col-md-3 pt-0">
      <div class="list-group list-group-flush account-settings-links">
       <a class="list-group-item list-group-item-action active" data-toggle="list" href="#user-basic-info"> <i class="fa fa-user-md"></i> <?php echo $this->lang->line('xin_e_details_basic');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#profile-picture"> <i class="fa fa-image"></i><?php echo $this->lang->line('xin_e_details_profile_picture');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#immigration"> <i class="fa fa-building"></i> <?php echo $this->lang->line('xin_employee_immigration');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#contacts"> <i class="fa fa-users"></i> <?php echo $this->lang->line('xin_employee_emergency_contacts');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#social-networking"> <i class="fa fa-globe"></i> <?php echo $this->lang->line('xin_e_details_social');?></a>
        <!-- <a class="list-group-item list-group-item-action" data-toggle="list" href="#documents"><i class="fa fa-file"></i> <?php echo $this->lang->line('xin_e_details_document');?></a> -->
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#qualification"> <i class="fa fa-graduation-cap"></i><?php echo $this->lang->line('xin_e_details_qualification');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#work-experience"><i class="fa fa-child"></i> <?php echo $this->lang->line('xin_e_details_w_experience');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#bank-account"><i class="fa fa-fax"></i> <?php echo $this->lang->line('xin_e_details_baccount');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#change-password"><i class="fa fa-lock"></i> <?php echo $this->lang->line('xin_e_details_cpassword');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#leave"><i class="fa fa-car"></i><?php echo $this->lang->line('xin_e_details_leave');?></a>
        <a class="list-group-item list-group-item-action" data-toggle="list" href="#sift"> <i class="fa fa-calendar"></i><?php echo $this->lang->line('xin_e_details_shift');?></a>
    ...
    <div class="col-md-9">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_employee_id');?>" name="id_absensi" type="text" value="<?php echo $id_absensi;?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group" id="department_ajax">
                    ...
                    <select multiple="" class="form-control" name="department_id[]" id="aj_department" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_department');?>">
                      <option value=""></option>
                      <?php foreach ($department_id as $department): ?>
                          <option value="<?php echo $department?>" selected><?php echo $department?></option>
                        <?php endforeach ?>
                      <?php foreach($all_departments as $key) {?>                        
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input class="form-control date" readonly="TRUE" placeholder="<?php echo $this->lang->line('xin_employee_doj');?>" name="date_of_joining" type="text" value="<?php echo $date_of_joining;?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
     ...
     <option value="1" <?php if($is_active=='1'):?> selected <?php endif; ?>><?php echo $this->lang->line('xin_employees_active');?></option>
                  ...
                  <div class="col-md-4">
                  <div class="form-group" id="type_emp">
                    <label for="department"><?php echo $this->lang->line('xin_type_emp');?></label>
                    <select class="form-control" name="contract_type_id" id="aj_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_type_emp');?>">
                      <option value=""></option>
                      <?php foreach($all_type as $type) {?>
                      <option value="<?php echo $type->contract_type_id?>" <?php if($contract_type_id==$type->contract_type_id):?> selected <?php endif;?>><?php echo $type->name?></option>
                      <?php } ?>
                    </select>
...
<!-- ---sift-- -->  
<div class="tab-pane fade" id="sift">
    <div class="box box-block bg-white">
      <form id="shift_info" action="<?php echo site_url("admin/employees/shift_info");?>" name="shift_info" method="post">
        <input type="hidden" name="user_id" value="<?php echo $user_id;?>">
        <input type="hidden" name="u_basic_info" value="UPDATE">
        <input type="hidden" name="<?php echo tokencookie() ?>" value="<?php echo tokenhash() ?>">
        <h6><?php echo $this->lang->line('xin_add_new');?> <?php echo $this->lang->line('xin_e_details_shift');?></h6>
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <button type="submit" class="btn btn-primary save col-right" class="save"><?php echo $this->lang->line('xin_save');?></button>
            </div>
          </div>
        </div>
      </form>
    ...
    <div class="box box-block bg-white">
      <h6><?php echo $this->lang->line('xin_list_all');?><?php echo $this->lang->line('xin_e_details_shift');?></h6>
          ...
          <h6 class="card-header">
            ...
            <div class="row">
              <?php foreach($all_leave_types as $type) {?>
                  ...
                  <?php
                  $total=$this->Timesheet_model->sisacuti($type->leave_type_id,$this->uri->segment(4));
              $terpakai = ($count_l) ? $total->total_days : 0 ;
                    if($count_l == 0){
                        $progress_class = '';
                        $count_data = 0;
                    } else {
                        $count_data = $terpakai / $type->days_per_year * 100;
                        // progress
                        if($count_data <= 20) {
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ml-3">
						...
						<?php echo $type->type_name;?> (<?php echo $terpakai;?>/<?php echo $type->days_per_year;?>)</div>
