          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="first_name"><?php echo $this->lang->line('contract');?></label>
                    <select class="form-control" name="contract" id="aj_company" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_company');?>">
                      <option value=""></option>
                      <?php foreach($contact as $key) {?>
                      <option value="<?php echo $key->contract_type_id?>"><?php echo $key->name?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group" id="department_ajax">
                    ...
                    <select multiple class="form-control" name="department_id[]" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_department');?>">
                      <option value=""></option>
                    </select>
                  </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_employee_id');?>" name="id_absensi" type="text" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
    ...
    <table class="datatables-demo table table-striped table-bordered" id="xin_table">
      <thead>
        ...
        <!--   <th><?php echo $this->lang->line('dashboard_email');?></th> -->
          ...
          <th><?php echo $this->lang->line('xin_type_emp');?></th>
