...
<div class="modal-body">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        <label for="from_date">Shift Date</label>
        <input class="form-control" readonly placeholder="<?php echo $this->lang->line('xin_e_details_frm_date');?>" name="shift_date" type="text" value="<?php echo $shift_date;?>">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label for="to_date" class="control-label">Shift List</label>
        <select name="shift" data-plugin="select_hrm" class="form-control">
          <?php foreach ($shift_all as $key): ?>
            <option value="<?php echo $key->office_shift_id?>" <?php echo ($shift_id==$key->office_shift_id)?"selected":"" ?>><?php echo $key->shift_name ?></option>
          <?php endforeach ?>
