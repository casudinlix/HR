            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control attendance_date" placeholder="<?php echo $this->lang->line('xin_e_details_date'); ?>" readonly id="start_date" name="start_date" type="text" value="<?php echo date('Y-m-d'); ?>">
                </div>
              <div class="col-md-12">
            <div class="form-group">
          ...
          <table class="datatables-demo table table-striped table-bordered" id="xin_table">
            <thead>
              <tr>
                ...
                <th><?php echo $this->lang->line('xin_attendance_date'); ?></th>
