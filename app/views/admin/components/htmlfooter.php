...
<script src="<?php echo tema();?>vendor/libs/popper/popper.js"></script>
<script src="<?php echo tema();?>vendor/js/bootstrap.js"></script>
<script src="<?php echo tema();?>vendor/js/sidenav.js"></script>

<!-- Libs -->
<script src="<?php echo tema();?>vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
<script src="<?php echo tema();?>vendor/libs/datatables/datatables.js"></script>
<script src="<?php echo tema();?>vendor/libs/bootstrap-select/bootstrap-select.js"></script>
<script src="<?php echo tema();?>vendor/libs/bootstrap-multiselect/bootstrap-multiselect.js"></script>
<script src="<?php echo tema();?>vendor/libs/select2/dist/js/select2.min.js"></script>
<script type="text/javascript" src="<?php echo tema();?>vendor/jquery-ui/jquery-ui.js"></script>
<script type="text/javascript" src="<?php echo tema();?>vendor/Trumbowyg/dist/trumbowyg.min.js"></script>
<script type="text/javascript" src="<?php echo tema();?>vendor/clockpicker/dist/jquery-clockpicker.min.js"></script>

<script src="<?php echo tema();?>js/demo.js"></script>
<?php if($this->router->fetch_class() =='reports'){?>
<script src="<?php echo tema();?>vendor/tables/datatable/dataTables.buttons.min.js" type="text/javascript"></script>
<script src="<?php echo tema();?>vendor/tables/datatable/buttons.bootstrap4.min.js" type="text/javascript"></script>
<script src="<?php echo tema();?>vendor/tables/jszip.min.js" type="text/javascript"></script>
<script src="<?php echo tema();?>vendor/tables/pdfmake.min.js" type="text/javascript"></script>
<script src="<?php echo tema();?>vendor/tables/vfs_fonts.js" type="text/javascript"></script>
<script src="<?php echo tema();?>vendor/tables/buttons.html5.min.js" type="text/javascript"></script>
<script src="<?php echo tema();?>vendor/tables/buttons.print.min.js" type="text/javascript"></script>
<script src="<?php echo tema();?>vendor/tables/buttons.colVis.min.js" type="text/javascript"></script>
<?php } ?>
<?php if($this->router->fetch_class() =='dashboard'){?>
<script type="text/javascript" src="<?php echo tema()?>scripts/user/set_clocking.js"></script>
<?php } ?>
<?php if($this->router->fetch_class() =='settings'){?>
<script src="<?php echo tema();?>vendor/libs/bootstrap-tagsinput/bootstrap-tagsinput.js"></script>
<?php }?>
...
<script type="text/javascript" src="<?php echo tema();?>vendor/ion.rangeSlider/js/ion-rangeSlider/ion.rangeSlider.min.js"></script>
<?php }?>
<?php if($this->router->fetch_class() =='chat'){?>
<script src="<?php echo tema();?>js/pages_chat.js"></script>
<?php }?>
<?php if($this->router->fetch_class() =='calendar' || $this->router->fetch_class() =='dashboard'){?>
	<script src="<?php echo tema();?>vendor/libs/moment/moment.js"></script>
	<script src="<?php echo tema();?>vendor/libs/fullcalendar/fullcalendar.js"></script>
...
<script type="text/javascript" src="<?php echo tema();?>vendor/toastr/toastr.min.js"></script>
<?php //if($this->router->fetch_class() !='dashboard'){?>
...
<script type="text/javascript" src="<?php echo tema();?>vendor/kendo/kendo.all.min.js"></script>
<?php $this->load->view('admin/roles/role_values');?>
<?php } ?>
<?php if($this->router->fetch_class() =='employees' && $this->router->fetch_method() =='hr') { ?>
<script src="<?php echo tema();?>js/pages_contacts.js"></script>
<?php } ?>
<script type="text/javascript" src="<?php echo tema().'scripts/'.$path_url.'.js'; ?>"></script>
...
<script type="text/javascript" src="<?php echo tema();?>vendor/printThis.js"></script>
<script type="text/javascript">
$(document).ready(function(){
